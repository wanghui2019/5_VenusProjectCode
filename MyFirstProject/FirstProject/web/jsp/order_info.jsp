...
<html>
	...
	<%@ include file="header.jsp"%>
		...
		<div class="container">
						...
						<tbody>
							...
							<tr class="active">
								<td width="60" width="40%">
									...
									<img src="${pageContext.request.contextPath}/${orderItems.product.pimage}" width="70" height="60">
								</td>
								<td width="30%">
									<a target="_blank"> ${orderItems.product.pname}</a>
								</td>
								<td width="20%">
									￥${orderItems.product.market_price}
								</td>
								<td width="10%">
                                        ${orderItems.quantity}
								</td>
								<td width="15%">
									<span class="subtotal">￥${orderItems.total}</span>
								</td>
							</tr>
                            </c:forEach>
						</tbody>
			...
			<form class="form-horizontal" style="margin-top:5px;margin-left:150px;" action="PayMoneyServlet?method=payMoney" method="post" id="orderForm">
			<div>
				<hr/>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="telephone" class="form-control" id="confirmpwd" placeholder="请输入联系方式" name="telephone">
						</div>
					</div>
