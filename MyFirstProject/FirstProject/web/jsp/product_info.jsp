...
<html>
		...
		<div class="container">
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
					<form action="${pageContext.request.contextPath}/CartServlet?method=addProduct" method="post" id="cartForm">
							<div><strong>${product.pname}</strong></div>
							<div style="border-bottom: 1px dotted #dddddd;width:350px;margin:10px 0 10px 0;">
								<div>编号：${product.pid}</div>
							</div>

							<div style="margin:10px 0 10px 0;">亿家价: <strong style="color:#ef0101;">&yen;：${product.market_price}元/份</strong> 参 考 价： <del>&yen;${product.shop_price}元/份</del>
							</div>
							...
							<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
								...
								<div style="margin:20px 0 10px 0;;text-align: center;">
									...
									<a href="javascript:void(0);">
										<input style="background: url('${pageContext.request.contextPath}/img/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0);height:36px;width:127px;" value="加入购物车" type="button" onclick="jumpCart()">
									</a> &nbsp;收藏商品
								</div>
							</div>
					</form>
	...
	<script>
		function jumpCart() {
			...
			<%--cartForm.method="get";--%>
			<%--cartForm.action="${pageContext.request.contextPath}/CartServlet?method=addProduct";--%>
			cartForm.submit();
		}
	</script>
